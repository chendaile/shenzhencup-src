...
system_path = "C:\\Users\\oft\\Documents\\ShenZhenCup\\output\\Q2\\Q2-0.5\\"
...
def export_path(project_id, tem_flag, path_ids = list(range(9, 19))+[5,6,7], save_path=system_path):
