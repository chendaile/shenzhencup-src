...
system_path = "C:\\Users\\oft\\Documents\\ShenZhenCup\\output\\Q2\\Q2v0-0.05\\"
...
def export_path(project_id, tem_flag, path_ids = list(range(6, 16)), save_path=system_path):
